...
/**
 * ListingModel Class Doc Comment
 *
 * @category Class
 * @package  AutoTrader\Client\Test
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ListingModel implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ListingModel';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['mileage']) && ($this->container['mileage'] > 10000000)) {
            $invalidProperties[] = "invalid value for 'mileage', must be smaller than or equal to 10000000.";
        }

        if (!is_null($this->container['mileage']) && ($this->container['mileage'] < 0)) {
            $invalidProperties[] = "invalid value for 'mileage', must be bigger than or equal to 0.";
        }

        if (!is_null($this->container['previous_owners']) && ($this->container['previous_owners'] > 10)) {
            $invalidProperties[] = "invalid value for 'previous_owners', must be smaller than or equal to 10.";
        }

        if (!is_null($this->container['previous_owners']) && ($this->container['previous_owners'] < 0)) {
            $invalidProperties[] = "invalid value for 'previous_owners', must be bigger than or equal to 0.";
        }
        ...
        if (!is_null($this->container['engine_capacity']) && ($this->container['engine_capacity'] > 2147483647)) {
            $invalidProperties[] = "invalid value for 'engine_capacity', must be smaller than or equal to 2147483647.";
        }

        if (!is_null($this->container['engine_capacity']) && ($this->container['engine_capacity'] < 1)) {
            $invalidProperties[] = "invalid value for 'engine_capacity', must be bigger than or equal to 1.";
        }
    ...
    {
        $allowedValues = $this->getNewUsedAllowableValues();
        if (!in_array($new_used, $allowedValues, true)) {
    ...
    public function setMileage($mileage)
    {
        ...
        if (!is_null($mileage) && ($mileage > 10000000)) {
            throw new \InvalidArgumentException('invalid value for $mileage when calling ListingModel., must be smaller than or equal to 10000000.');
        }
        if (!is_null($mileage) && ($mileage < 0)) {
            throw new \InvalidArgumentException('invalid value for $mileage when calling ListingModel., must be bigger than or equal to 0.');
        }
    ...
    public function setPreviousOwners($previous_owners)
    {
        ...
        if (!is_null($previous_owners) && ($previous_owners > 10)) {
            throw new \InvalidArgumentException('invalid value for $previous_owners when calling ListingModel., must be smaller than or equal to 10.');
        }
        if (!is_null($previous_owners) && ($previous_owners < 0)) {
            throw new \InvalidArgumentException('invalid value for $previous_owners when calling ListingModel., must be bigger than or equal to 0.');
        }
    ...
    public function setEngineCapacity($engine_capacity)
    {
        ...
        if (!is_null($engine_capacity) && ($engine_capacity > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $engine_capacity when calling ListingModel., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($engine_capacity) && ($engine_capacity < 1)) {
            throw new \InvalidArgumentException('invalid value for $engine_capacity when calling ListingModel., must be bigger than or equal to 1.');
        }
